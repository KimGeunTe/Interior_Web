...
var ContextMenu = function(blueprint3d) {
  ...
  function init() {
	...
	$('#context-menu-detail').click(function() {
		var detailUrl = selectedItem.metadata.modelUrl.replace('/mesh/thumb.js', '');
		$('#ifr_detail').attr('src', detailUrl);
	});
  }
